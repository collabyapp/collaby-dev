...
import 'package:collaby_app/view/settings_view/help_support_view.dart';
...
class AppRoutes {
  static List<GetPage> appRoutes() => [
    ...
    GetPage(name: RouteName.onboardingView, page: () => const OnboardingView()),
    GetPage(name: RouteName.logInView, page: () => const LoginView()),
    GetPage(name: RouteName.signUpView, page: () => const SignUpView()),
    GetPage(name: RouteName.otpView, page: () => const VerificationCodeView()),
    GetPage(
    ...
    GetPage(name: RouteName.profileSetUpView, page: () => ProfileSetupView()),
    GetPage(
    ...
    GetPage(name: RouteName.phoneNumberView, page: () => PhoneNumberView()),
    GetPage(
    ...
    GetPage(name: RouteName.gigSuccessView, page: () => const GigSuccessView()),
    GetPage(
    ...
    GetPage(
      ...
      page: () =>
          JobDetailsView(jobId: (Get.arguments?['jobId'] ?? '').toString()),
    ),
    GetPage(name: RouteName.settingsView, page: () => SettingsView()),
    GetPage(name: RouteName.creatorLevelView, page: () => CreatorLevelView()),
    GetPage(name: RouteName.helpSupportView, page: () => HelpSupportView()),
    GetPage(
      name: RouteName.withdrawalView,
      page: () => BillingWithdrawalScreen(),
    ),
    GetPage(name: RouteName.gigDetailView, page: () => const GigDetailView()),
  ];
}
